...
//
        pref = getSharedPreferences("session_mepl", MODE_PRIVATE);
        headerId = pref.getString("headerId", "");
        userCode = pref.getString("userCode", "");
        orgnTypeValue = pref.getString("orgntype", "");
        empType = pref.getString("empType", "");
        crop = pref.getString("crop", "");
        variety = pref.getString("variety", "");
        baleStart = crop + "" + variety + "" + orgnTypeValue;
...
//        Intent intent = new Intent(LotCreation.this,LotViewActivity.class);
////        intent.putExtra("RefId",RefId);
//        startActivity(intent);

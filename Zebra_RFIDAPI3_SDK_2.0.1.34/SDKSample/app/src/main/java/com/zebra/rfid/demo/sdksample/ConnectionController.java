...
import static com.zebra.rfid.demo.sdksample.ProfileContent.UpdateProfilesForRegulatory;
...
public class ConnectionController {
    ...
    public void AutoConnectDevice(final String password, final RfidEventsListener rfidEventsListener, final RfidListeners rfidListeners) {

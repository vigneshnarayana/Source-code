...
//            e.printStackTrace();
//        }
//        if (preFilters[0].getMemoryBank().contains("EPC") && com.zebra.rfidreader.demo.rfid.RFIDController.preFilters[0].getAction() == 4 && com.zebra.rfidreader.demo.rfid.RFIDController.preFilters[1] == null)
//            return true;

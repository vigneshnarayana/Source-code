...
public class MappingSelectLocation extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void adapter() {
        ...
        Spinner spin = (Spinner) findViewById(R.id.et_loc);
